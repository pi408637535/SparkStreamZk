...
object PushRedisConstants {
	...
	//-------------------------------------------------------------------
	//盯盘精灵 INC_DROP_STOP  保存被监测的股票
	val STOCK_PUSH_ELF_INC_DROP_STOP_RESULT_INC_STOCK_SET = "STOCK:PUSH:ELF:INC:DROP:STOP:RESULT:INC:STOCK:SET"
	val STOCK_PUSH_ELF_INC_DROP_STOP_RESULT_DOWN_STOCK_SET = "STOCK:PUSH:ELF:INC:DROP:STOP:RESULT:DOWN:STOCK:SET"
